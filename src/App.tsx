      ...
      <section className="py-12 bg-white relative overflow-hidden border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 w-full">
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center items-center gap-x-6 gap-y-4 md:gap-x-10 transition-all duration-500 overflow-x-auto no-scrollbar py-2">
            ...
            {/* Meta — official infinity figure-8 */}
            <div className="flex items-center gap-2 flex-shrink-0">
              <svg width="40" height="22" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="meta-grad" x1="0" y1="15" x2="60" y2="15" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stopColor="#0064E1"/>
                    <stop offset="50%" stopColor="#0078FF"/>
                    <stop offset="100%" stopColor="#00C2FF"/>
                  </linearGradient>
                </defs>
                <path d="M7 15C7 10 9.5 5.5 13.5 5.5C16.5 5.5 18.5 7.5 21 11.5L30 24.5L39 11.5C41.5 7.5 43.5 5.5 46.5 5.5C50.5 5.5 53 10 53 15C53 20 50.5 24.5 46.5 24.5C43.5 24.5 41.5 22.5 39 18.5L30 5.5L21 18.5C18.5 22.5 16.5 24.5 13.5 24.5C9.5 24.5 7 20 7 15Z" stroke="url(#meta-grad)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
              </svg>
